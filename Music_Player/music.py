...
dpg.create_context()
dpg.create_viewport(title="Music Player")
pygame.mixer.init()
...
with dpg.theme(tag="base"):
	with dpg.theme_component():
		dpg.add_theme_color(dpg.mvThemeCol_Button, (27, 79, 28))
		dpg.add_theme_color(dpg.mvThemeCol_ButtonActive, (30, 90, 255, 95))
		dpg.add_theme_color(dpg.mvThemeCol_ButtonHovered, (30, 90, 255))
		...
		dpg.add_theme_color(dpg.mvThemeCol_TitleBgActive, (27, 79,28 ))
		dpg.add_theme_color(dpg.mvThemeCol_CheckMark, (40, 54, 28))
		dpg.add_theme_color(dpg.mvThemeCol_FrameBgHovered, (172, 174, 197))

with dpg.theme(tag="slider_thin"):
	with dpg.theme_component():
		dpg.add_theme_color(dpg.mvThemeCol_FrameBgActive, (27, 79,28 ,99))
		dpg.add_theme_color(dpg.mvThemeCol_FrameBgHovered, (27, 79,28 ,60))
		dpg.add_theme_color(dpg.mvThemeCol_SliderGrabActive, (255, 255, 255))
		dpg.add_theme_color(dpg.mvThemeCol_SliderGrab, (255, 255, 255))
		dpg.add_theme_color(dpg.mvThemeCol_FrameBg, (27, 79,28 ,99))
...
with dpg.theme(tag="slider"):
	with dpg.theme_component():
		dpg.add_theme_color(dpg.mvThemeCol_FrameBgActive, (27, 79,28 ,99))
		dpg.add_theme_color(dpg.mvThemeCol_FrameBgHovered, (27, 79,28 ,99))
		dpg.add_theme_color(dpg.mvThemeCol_SliderGrabActive, (255, 255, 255))
		dpg.add_theme_color(dpg.mvThemeCol_SliderGrab, (255, 255, 255))
		dpg.add_theme_color(dpg.mvThemeCol_FrameBg, (27, 79,28 ,99))
		dpg.add_theme_style(dpg.mvStyleVar_GrabRounding, 3)
...
with dpg.window(tag="main",label="window title"):
	...
	with dpg.group(horizontal=True):
		with dpg.child_window(width=200,tag="sidebar"):
			dpg.add_text("Music Player",color=(128, 0, 128))
			dpg.add_text("Build by Kaushik Pranay")
			dpg.add_spacer(height=2)
#dpg.add_button(label="Support",width=-1,height=23,callback=lambda:webbrowser.open(url=""))
